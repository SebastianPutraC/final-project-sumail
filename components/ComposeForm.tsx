                  ...
                  >
                      <div className="relative">
                          <div className="flex items-center">
                              ...
                              {selectedReceiver && (
                                  <div
                                      className="flex items-center gap-2 bg-blue-100 text-blue-700 px-2 rounded-full w-fit">
                                      {typeof selectedReceiver === "string"
                                          ? selectedReceiver
                                          : selectedReceiver.email}
                                      <button
                          ...
                          {suggestions.length > 0 && (
                              <div
                                  className="absolute bg-white border border-gray-200 w-full rounded shadow-md mt-1 z-10">
                                  {suggestions.map((u) => (
                                      <div
                                          key={u.id}
